...
【cn 模板 · 字段与篇幅要求】严格按此结构，每个字段都要写满，不可偷工：
{
 "template":"cn",
 ...
 // 嵌字诗：每句7字，句首字依次是姓名各字。两字名出2句，三字名出4句
 "analysis":[
 ...
 // 每个汉字一条，与 chars 对应；q=古籍引文，from=真实出处，benyi/yinshen 各配一句补充，四个子字段都要填
