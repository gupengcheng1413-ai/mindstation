...
【cn 模板 · 字段说明】按此结构输出，简洁为宜、宁缺毋滥，不硬凑字数：
{
 ...
 // 最多3位同姓名人（历史/文化/文学皆可），简洁为宜、宁缺毋滥，各配朝代身份、代表、一句话
 "english":[
   {"name":"Ray","ipa":"","src":"古英语「光线」","map":"音近「雷」"},
   {"name":"Thor","ipa":"[θɔːr]","src":"北欧雷神","map":"呼应「雷」之势"},
   {"name":"Lincoln","ipa":"[ˈlɪŋkən]","src":"林肯，领袖之名","map":"呼应「军」统帅"}
 ],
 // 最多3个英文名，给学生起不土的英文名。三种取法择优混用：①音译联想—发音贴近中文名某字(如"瑶"→Charlotte)；②寓意契合—对应中文字义(如"静"→Irene和平女神、"胜"→Victor)；③首字母一致。src=词源/含义，map=与姓名的呼应(说明用了哪种取法)。避免烂大街的 Tom/Jack。
